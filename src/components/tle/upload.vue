<template>
    ...
    <!-- <div style="height:40px;">
        <b-row  >
            ...
            <p class="fake-legend-2 text-success"><span style="font-size:1em;">TLE Data Upload</span></p> 
    ...
    <main class="site-wrapper">
        ...
        <div id="id-content" style="margin:1em;">

            <div id="tab-container-1" style="height:80vh;overflow-x:hidden;border :0px dashed #5F1854;margin-top:0em;"> 
                
                <p class="fake-legend text-success"><span>Process</span></p> 

                <b-row class="text-center mt-5" >
                    <b-col sm=1></b-col>
                    <b-col sm=11 style="border:0px solid red;" >
        ...
        <div id="main-container-1" style="height:80vh;overflow:auto;border :0px dashed #5F1854;" >
            ...
            <div class="row ml-4" >
             ...
             <b-row class="text-center mt-0"  v-show="step==0 || step==1">

                <p class="fake-legend text-success "><span>Drop file</span></p>

                <div class="col-xl-12 col-sm-12 col-12  " style="cursor:pointer;margin-top:1.5em;" @click="upload_file">
             ...
             <b-row class="text-center"  v-show="step==2">
                
                    <p class="fake-legend text-success "><span>Table data</span></p>
                    <b-table    
                                ...
                                :filter="filter" 
                                :fields="fields"      
                                style="font-size:0.9em;font-weight:bold;margin-top:1em;"   
                                ...
                                <template #thead-top="data">
                                    <b-tr>
                                        <b-th colspan="3" variant="primary"><span>Total TLE : {{totalRows * perPage}} {{data.x}}</span></b-th>
                                    </b-tr> 
                                </template>
                ...
                <div class="card bbtn border-primary border-2 mt-1 border-right-0 border-left-0 border-bottom-0  text-success rounded-0" style="margin-bottom:0.5em;height:10vh;justify-content: center;" >
                    ...
                    <b-col cols="3">
                        ...
                        <button class="  btn btn-outline-danger rounded-0 w-100 border-2" @click="step=1" >
                        <i class="fa fa-backward" aria-hidden="true"></i><span style="margin-left:1em;"> Prev Step  </span>
                        </button>
                    ...
                    <b-col  cols="3" >
                        ...
                        <button class=" btn btn-outline-success rounded-0 w-100 border-2" @click="step=3" >
                        <span style="margin-right:1em;"> Next Step  </span><i class="fa fa-forward" aria-hidden="true"></i>
                        </button>
            ...
            <!-- ---------------------------------------------------------------------------------   -->
             ...
             <b-row class="text-center "  v-show="step==3">

                <p class="fake-legend text-success "><span>Group : [ {{tag}} ]</span></p>
                  
                                    
                                                <div class="media-body text-left ml-3 align-self-center" >
                                                  ...
                                                  <b-row class="mt-4"> 
                                                    ...
                                                    <b-form-checkbox-group 
                                                      ...
                                                      style="font-size:1em;font-weight:bold;color:#000;cursor:pointer;margin-bottom:2em;"
                                                      stacked
                                                      switches
                ...
                <div class="card bbtn border-primary border-2 mt-1 border-right-0 border-left-0 border-bottom-0  text-success rounded-0" style="margin-bottom:0.5em;height:10vh;justify-content: center;" >
                    ...
                    <b-col cols="3">
                        ...
                        <button class="  btn btn-outline-danger rounded-0 w-100 border-2" @click="step=2" >
                        <i class="fa fa-backward" aria-hidden="true"></i><span style="margin-left:1em;"> Prev Step  </span>
                        </button>
                    ...
                    <b-col  cols="3" >
                        ...
                        <button class=" btn btn-outline-success rounded-0 w-100 border-2" @click="step=4" >
                        <span style="margin-right:1em;"> Next Step  </span><i class="fa fa-forward" aria-hidden="true"></i>
                        </button>
            ...
            <!-- ---------------------------------------------------------------------------------   -->
             ...
             <b-row class="text-center "  v-show="step==4">

                <p class="fake-legend text-success "><span>Before upload</span></p>
                ...
                <b-table-simple  small stacked >
                                ...
                                <b-tr>
                                    ...
                                    <b-td stacked-heading="Tags :"><span style="font-size:0.8em;">[ {{tag}} ]</span></b-td>
                ...
                <div class="card bbtn border-primary border-2 mt-1 border-right-0 border-left-0 border-bottom-0  text-success rounded-0" style="margin-bottom:0.5em;height:10vh;justify-content: center;" >
                    ...
                    <b-col cols="3">
                        ...
                        <button class="  btn btn-outline-danger rounded-0 w-100 border-2" @click="step=3" >
                        <i class="fa fa-backward" aria-hidden="true"></i><span style="margin-left:1em;"> Prev Step  </span>
                        </button>
                    ...
                    <b-col  cols="3" >
                        ...
                        <button class=" btn btn-outline-success rounded-0 w-100 border-2" @click="confirm_before_save_box=true" >
                        <span style="margin-right:1em;"> Upload data  </span><i class="fa fa-cloud-upload" aria-hidden="true"></i>
                        </button>
             ...
             <!-- Submit OK-->
             <!-- ==============================================================================================   -->  
             <b-row class="text-center "  v-show="step==5">
                 
                 <p class="fake-legend text-success "><span>Upload Complate</span></p>
                        
                            <div class="row text-center text-success" style="margin-top:4em;"> 
                            
                                <span style=" font-size:4em;"><i class="far fa-check-circle" ></i></span>
                                <span style=" font-size:2em;margin-top:0.5em;"> Upload Complate </span>
  ...
  data() {
            return {    
                ...
                options: [
                    ...
                    { value: 'Full Catalog', text: "Full Catalog", disabled: false },

                    { value: 'Last Launches 30 Days', text: "Last Launches 30 Days", disabled: false }, 
                    { value: 'Space Stations', text: "Space Stations", disabled: false  }, 

                    { value: 'Active Geosynchronous', text: "Active Geosynchronous", disabled: false  },

                    // { value: 'Navigation Satellites', text: "Navigation Satellites", disabled: false  }, 
                    // { value: 'Communications Satellites', text: "Communications Satellites", disabled: false },
                    
                    { value: 'Starlink', text: "Starlink", disabled: false },
                    { value: 'Beidou', text: "Beidou", disabled: false },


                    { value: 'Thai Area', text: "Thai Area", disabled: false  },
    ...
    methods: {
        save_customers_csv : async function(){
            ...
            await this.delete_tle( this.tag )
            let d = await this.round_save_csv( this.arr, this.tag )
        ...
        round_save_csv : async function( arr, tag ) { 
            ...
            for(let i=0;i<this.limit_round_send;i++){
                ...
                await this._loop ( i, send_arr, tag)
            ...
            // this.limit_round_send.forEach((_socket) => {
    ...
    watch: {
       ...
       tags () {
           ...
           if( this.tags.length > 0 ){
               ...
               this.tag = JSON.parse(JSON.stringify( this.tags[ this.tags.length - 1 ] )) 
...
/* https://stackoverflow.com/questions/18656995/create-vertical-tab-using-html-css */
 #id-content
  ...
  #tab-container-1 ul li a:visited
  {
    text-decoration: none;
    color: #666;
    display: block;
  ...
  #tab-container-1 ul li.tab-selected
  {
    border-right: none;
...
.fake-legend {
  ...
  border-bottom: solid 3px #1363DF;
  text-align: center;
  /* margin: 1em 0; */
  margin-top:1em;
  margin-bottom:1.5em;
