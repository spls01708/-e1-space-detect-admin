                        ...
                        <div class="media-body text-left ml-0 align-self-center" style="zoom:0.9" >
                           ...
                           <div id="id-content" >
                             ...
                             <div id="main-container" style="margin-bottom:0.5em;height:70vh;overflow:auto;" >
                                <!-- ------------------------------------------------- --> 
                                <b-row class="w-100 text-center mt-2" style="margin-bottom:30em;">
                                  <b-col sm=4></b-col>
                                  <b-col>
                                      <canvas id="canvas" width="500" height="500" style="zoom:1.1" ></canvas>
                                  </b-col>
                                  <b-col sm=4></b-col>
                                </b-row>
                                      ...
                                      <b-row style="zoom:0.9;" v-if="editor_lock==false">
                                        ...
                                        <!-- <b-col>
                                          <button class="  btn btn-outline-info rounded-0 w-100 border-2 "  disabled > 
                                                <i class="fa fa-edit" aria-hidden="true"></i><span style="margin-left:1em;"> TLE </span>
                                          </button> 
                                        </b-col> -->
                                          
                                        <b-col>
                                          <button class="  btn btn-outline-info rounded-0 w-100 border-2 " @click="fn_add_file()"  > 
                                                <i class="fa fa-paperclip" aria-hidden="true"></i><span style="margin-left:1em;"> Footprint </span>
                                          </button> 
                                        </b-col>

                                        <b-col>
                                          <button class="  btn btn-outline-info rounded-0 w-100 border-2 "  @click="fn_add_editor()" disabled> 
