        ...
        <b-row  >
            ...
            <nav class="nav-top" >       
                ...
                <a class="nav__link"> 
                    ...
                    <span class="w-100" style="font-size:1.3em;color:#FFFFFF"> TLE Data </span>
      ...
      <div class="media-body text-left ml-0 align-self-center" style="zoom:0.9;margin-top:1em;height:83vh" >
        ...
        <b-row style="margin:1em;"  class="text-center" >
                    ...
                    <b-col cols="7" class="p-2 text-center"   >
                      <b-form-input id="input-valid" style="cursor:pointer;margin-left:-1em;font-size:1.1em;"  
        ...
        <div id="id-content" style="margin-top:-1em;">
          <div id="tab-container-2" style="height:80vh;overflow-x:hidden; "> 
          <!-- -------------------------------------------------------------------------   -->
          ...
          <div class="col-12 " v-for="(data,index) in tle_type_menu" :key="index">
            ...
            <div class="card-content text-left m-2">
                    ...
                    <span :class="data.selected==true ? 'font-weight-bold text-primary' :  'font-weight-bold text-dark'">
                      ...
                      <span >{{data.name}} </span> 
                          <span class="aaa"></span>
                          <span style="font-size:0.9em;float:right;">{{totalRows}} entries</span>
                      </section>
          ...
          <div id="main-container-2" style="height:80vh;overflow:auto;zoom:0.9;border-left:2px dashed #5F1854;" >
            
          <div class="row ml-2 mr-2" style="margin-top:-0.9em;">
